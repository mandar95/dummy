...
function Graph3(props) {
  ...
  useLayoutEffect(() => {
    ...
    let chart = am4core.create("chartdiv9", am4charts.PieChart);
    ...
    pieSeries.dataFields.value = "claims_settled";
    pieSeries.dataFields.category = "tpa_name";
    ...
    pieSeries2.dataFields.value = "claims_registered";
    pieSeries2.dataFields.category = "tpa_name";
    ...
    pieSeries3.dataFields.value = "claims_settled";
    pieSeries3.dataFields.category = "tpa_name";
  ...
  return <div id="chartdiv9" style={{ width: "100%", height: "450px" }}></div>;
}
