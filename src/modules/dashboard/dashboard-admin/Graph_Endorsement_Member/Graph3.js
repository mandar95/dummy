...
function Graph3(props) {
  ...
  useLayoutEffect(() => {
    ...
    pieSeries.dataFields.value = "active_lives";
    ...
    pieSeries2.dataFields.value = "active_policies";
    ...
    pieSeries3.dataFields.value = "active_clients";
    ...
    pieSeries4.dataFields.value = "total_clients";
