...
function Graph2(props) {
  ...
  useLayoutEffect(() => {
    ...
    series2.columns.template.tooltipText =
      "{name}: {valueY.totalPercent.formatNumber('#.00')}%";
    series2.name = "Active Clients";
    series2.dataFields.categoryX = "name";
    series2.dataFields.valueY = "active_clients";
    ...
    series3.columns.template.tooltipText =
      "{name}: {valueY.totalPercent.formatNumber('#.00')}%";
    series3.name = "Active Policies";
    series3.dataFields.categoryX = "name";
    series3.dataFields.valueY = "active_policies";
    ...
    series4.columns.template.tooltipText =
      "{name}: {valueY.totalPercent.formatNumber('#.00')}%";
    series4.name = "Active Lives";
    series4.dataFields.categoryX = "name";
    series4.dataFields.valueY = "active_lives";
