...
function Graph2(props) {
  ...
  useLayoutEffect(() => {
    ...
    series1.dataFields.valueY = "monthly";
    ...
    series2.dataFields.valueY = "quaterly";
    ...
    series3.columns.template.tooltipText =
      "{plan}: {valueY.totalPercent.formatNumber('#.00')}%";
    series3.name = "Half Year";
    series3.dataFields.categoryX = "plan";
    series3.dataFields.valueY = "half";
    ...
    series4.columns.template.tooltipText =
      "{plan}: {valueY.totalPercent.formatNumber('#.00')}%";
    series4.name = "Annually";
    series4.dataFields.categoryX = "plan";
    series4.dataFields.valueY = "annualy";
  ...
  return <div id="chartdiv1" style={{ width: "100%", height: "450px" }}></div>;
}
