...
function Graph3(props) {
  ...
  useLayoutEffect(() => {
    ...
    pieSeries.dataFields.value = "annualy";
    ...
    pieSeries2.dataFields.value = "half";
    ...
    pieSeries3.dataFields.value = "quaterly";
    ...
    pieSeries4.dataFields.value = "monthly";
  ...
  return <div id="chartdiv2" style={{ width: "100%", height: "450px" }}></div>;
}
