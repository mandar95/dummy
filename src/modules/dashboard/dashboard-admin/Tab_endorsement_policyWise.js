...
import Table from "./Endorsement_PolicyWise/Table";
import Graph1 from "./Endorsement_PolicyWise/Graph1";
import Graph2 from "./Endorsement_PolicyWise/Graph2";
import { getClaimSummary, selectClaimsData } from "./dashboard_admin.slice";

function ControlledTabs(props) {
  //selectors
  const dispatch = useDispatch();
  const GraphData = useSelector(selectClaimsData);
