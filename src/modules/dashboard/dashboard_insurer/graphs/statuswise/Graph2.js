...
function Graph1(props) {
  ...
  useLayoutEffect(() => {
    ...
    series1.columns.template.tooltipText =
      "{labels}: {valueY.totalPercent.formatNumber('#.00')}%";
    series1.name = "Deficiency";
    series1.dataFields.categoryX = "labels";
    series1.dataFields.valueY = "Deficiency";
    ...
    series2.dataFields.valueY = "Lost";
    ...
    series3.columns.template.tooltipText =
      "{labels}: {valueY.totalPercent.formatNumber('#.00')}%";
    series3.name = "Open";
    series3.dataFields.categoryX = "labels";
    ...
    series4.columns.template.tooltipText =
      "{labels}: {valueY.totalPercent.formatNumber('#.00')}%";
    series4.name = "Reject";
    series4.dataFields.categoryX = "labels";
    series4.dataFields.valueY = "Reject";
    ...
    series5.columns.template.tooltipText =
      "{labels}: {valueY.totalPercent.formatNumber('#.00')}%";
    series5.name = "Won";
    series5.dataFields.categoryX = "labels";
  ...
  return <div id="chartdiv3" style={{ width: "100%", height: "450px" }}></div>;
}
