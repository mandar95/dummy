...
function Graph1(props) {
  ...
  useLayoutEffect(() => {
    ...
    pieSeries.dataFields.value = "Deficiency";
    ...
    pieSeries2.dataFields.value = "Lost";
    ...
    pieSeries3.dataFields.value = "Open";
    pieSeries3.dataFields.category = "labels";
    ...
    pieSeries4.dataFields.value = "Reject";
    pieSeries4.dataFields.category = "labels";
    pieSeries4.slices.template.stroke = am4core.color("#fff");
    pieSeries4.slices.template.strokeWidth = 2;
    pieSeries4.labels.template.text = "{value.percent.formatNumber('#.0')}%";
    ...
    pieSeries5.dataFields.value = "Won";
    pieSeries5.dataFields.category = "labels";
  ...
  return <div id="chartdiv4" style={{ width: "100%", height: "450px" }}></div>;
}
