...
function Graph1(props) {
  ...
  useLayoutEffect(() => {
    ...
    // let Max = _.max(props.GraphData, "count") + 1;
    // let Min = _.min(props.GraphData, "count") - 10;

    let Max = (_.maxBy(props.GraphData, "count")?.count || 1) + 1;
    let Min = 0;
    ...
    categoryAxis.title.text = "Relations";
    ...
    // categoryAxis.renderer.labels.template.maxHeight = 500;
    ...
    series.columns.template.tooltipText = "{valueY.value} Enroled";
    ...
    circleBullet.tooltipText = "{valueY.value} Enroled";
