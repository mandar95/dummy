...
function Graph3(props) {
  ...
  useLayoutEffect(() => {
    // let x = am4core.create("chartdiv15", am4charts.XYChart);
    ...
    pieSeries.dataFields.value = "total_claim";
    pieSeries.dataFields.category = "category";
    pieSeries.slices.template.stroke = am4core.color("#fff");
    pieSeries.slices.template.strokeWidth = 2;
    pieSeries.slices.template.strokeOpacity = 1;
    pieSeries.slices.template.tooltipText = "{category}: {value.value} Claims";
    ...
    pieSeries2.dataFields.value = "total_employees";
    ...
    pieSeries2.slices.template.tooltipText = "{category}: {value.value} Employees";
  ...
  return <div id="chartdiv15" style={{ width: "100%", height: "450px" }}></div>;
}
