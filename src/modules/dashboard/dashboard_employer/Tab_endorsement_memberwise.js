...
function ControlledTabs(props) {
  ...
  return (
    <div style={{ marginTop: "10px", minHeight: "450px" }}>
      ...
      <label style={{ fontSize: fontSize ? `calc(20px + ${fontSize - 92}%)` : '20px' }}>Endorsement Member Wise</label>
    </div>
  );
}
