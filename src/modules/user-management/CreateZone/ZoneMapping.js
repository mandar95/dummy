...
import AddZoneMapping from "./AddZoneMapping";
...
import { getState, selectState, clear, getZonalMappingdata, deleteZonalMapping } from '../user.slice';


export const ZoneMapping = ({ myModule }) => {

    const dispatch = useDispatch();
    const { userType } = useParams();
    const states = useSelector(selectState);
    const { zonal_data, success, error, loading } = useSelector((state) => state.userManagement);
        ...
        <Card title={
            ...
            {!_.isEmpty(zonal_data) ? (
                <DataTable
                    ...
                    removeAction={deleteZonalMapping}
