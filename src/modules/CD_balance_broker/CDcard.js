						...
						<Col sm={12} md={12} lg={6} xl={6}>
							<ul>
								<li style={styles.list}>
									<Label>
										Policy No
										<SpanFloatRight>{policyDetails?.policy_number}</SpanFloatRight>
									</Label>
									<Label>
										Total Employee
										<SpanFloatRight>{policyDetails?.employee_count}</SpanFloatRight>
									</Label>
									<Label>
										Members Covered
										<SpanFloatRight>{policyDetails?.total_members}</SpanFloatRight>
									</Label>
									<Label>
										Sum Insured
										<SpanFloatRight>{policyDetails?.total_suminsured}</SpanFloatRight>
									</Label>
								</li>
							</ul>
						</Col>
