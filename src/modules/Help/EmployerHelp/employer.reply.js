...
import { EmployerQueryResolve } from '../help.slice'
...
export const EmployerReplyModal = (props) => {

    const { show, onHide, id, replyText } = props
    ...
    const onSubmit = (data) => {
        ...
        if (id) {
            ...
            dispatch(EmployerQueryResolve(id, {
                action,
                status: status || "1"
            }));
        ...
        >
            <Modal.Header>
                <Modal.Title id="contained-modal-title-vcenter">
                    <Head>Queries & Complaints Response</Head>
                </Modal.Title>
            </Modal.Header>
