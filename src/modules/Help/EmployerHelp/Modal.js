...
import {
    getQueryType, getQuerySubType, createEmpOrgQueries, setEmployeeQuery, setEmployeeSubQuery, setEmployeeComments, help
} from '../help.slice'
...
export const AddQuery = ({ show, onHide }) => {
    ...
    const onSubmit = (data) => {
        ...
        dispatch(createEmpOrgQueries(formData));
        onHide()
    }
